...
final class DoseEventExpanderTest extends TestCase
{
    ...
    {
        $startDate = new \DateTimeImmutable('2026-08-01 00:00:00');
        $endDate = new \DateTimeImmutable('2026-08-03 23:59:59');
        ...
        $to = new \DateTimeImmutable('2026-08-02 23:59:59');

        $events = $this->expander->expand($schedule, $from, $to);
    ...
    public function testExpandDailyIntervalScheduleSpanningMidnight(): void
    {
        ...
        $from = new \DateTimeImmutable('2026-08-01 00:00:00');
        $to = new \DateTimeImmutable('2026-08-02 12:00:00');
    ...
    public function testExpandSpecificDaysSchedule(): void
    {
        ...
        $startDate = new \DateTimeImmutable('2026-08-03 00:00:00');
        ...
        $from = new \DateTimeImmutable('2026-08-03 00:00:00');
        $to = new \DateTimeImmutable('2026-08-05 23:59:59');
